 ...
 */
export declare interface SmsClientOptions extends CommonClientOptions {
}

/**
 * Options to configure Sms requests
 */
export declare interface SmsSendOptions extends OperationOptions {
    /**
 ...
 */
export declare interface SmsSendRequest {
    /**
